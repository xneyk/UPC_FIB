...
class Stack {
  ...
  public:
   ...
   Stack() {
      ...
      linked_with = nullptr; // it means it's not linked with an other stack.
   }
   ...
   void push(T value) {
      ...
      if (linked_with != nullptr) {
         Item *p_linked_item = new Item();
         p_linked_item->value = value;
         p_linked_item->next = linked_with->ptopitem;
         linked_with->ptopitem = p_linked_item;
         linked_with->_size += 1;
      }
