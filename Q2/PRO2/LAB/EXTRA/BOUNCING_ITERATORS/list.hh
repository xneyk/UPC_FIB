  ...
  public:
   ...
   class iterator {
     ...
     private:
      ...
      bool inverted;  // if true it inverts the direction of ++ and --.
     public:
      iterator() {
      ...
      {
         if (((!inverted) and pitem == &(plist->itemsup)) or (inverted and pitem == plist->iteminf.next)) { // bounce at dend or bounce at begin.
            inverted = !inverted;
         } else {
            if (inverted) {
               pitem = pitem->prev;
      ...
      /* Post: el p.i apunta a l'element anterior a E,
         el resultat és el p.i. */
      {
         if (((!inverted) and pitem == plist->iteminf.next) or (inverted and pitem == &(plist->itemsup))) { // bounce at begin or bounce at end.
            inverted = !inverted;
         } else {
            if (inverted) {
               pitem = pitem->next;
