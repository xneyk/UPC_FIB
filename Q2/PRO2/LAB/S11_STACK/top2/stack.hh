...
class Stack {
  ...
  public:
   ...
   void push(T value) {
      ...
      ptop2item = ptopitem; // El segon del top es ara el que era el top.
      ptopitem = pnewitem;
      _size++;
   }
   ...
   void pop() {
      ...
      if (ptop2item != NULL) ptop2item = ptop2item->next; // Ara el top2 es el que era top 3.
      delete paux;
      _size--;
   }
   ...
   T top2() {
      if (ptop2item == NULL) return this->top();
      else {
