...
class MyGLWidget : public BL2GLWidget {
   ...
   private:
      ...
      // Calcula i envia al VS la TG del objecte Patricio1
      void patricio1ModelTransform();

      // Calcula i envia al VS la TG del objecte Patricio1
      void patricio2ModelTransform();

      // Calcula i envia al VS la TG del objecte Patricio1
      void patricio3ModelTransform();

      // Calcula i envia al VS la TG del objecte Patricio1
      void patricio4ModelTransform();
      ...
      float prespective_zoom_factor;
      float ortho_zoom_factor;
