...
public class TestPayStation {
    LinearRate linearRate = new LinearRate();
    PayStation ps = new PayStationImpl( linearRate );
    ProgressiveRate progressiveRate = new ProgressiveRate();
    PayStation ps1 = new PayStationImpl( progressiveRate );
